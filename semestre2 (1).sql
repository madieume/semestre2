...
CREATE TABLE IF NOT EXISTS `artdette` (
...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  `refar` varchar(100) NOT NULL,
  `libar` varchar(100) NOT NULL,
...
INSERT INTO `article` (`idar`, `refar`, `libar`, `prixU`, `qteStock`) VALUES
...
INSERT INTO `client` (`idcl`, `nomcl`, `prenomcl`, `telephone`, `email`, `adresse`, `sexe`, `photo`, `categorie`) VALUES
...
CREATE TABLE IF NOT EXISTS `depot` (
  ...
  `numerodep` varchar(100) NOT NULL,
...
INSERT INTO `depot` (`iddep`, `numerodep`, `montantdep`, `datedep`, `idClient`) VALUES
...
CREATE TABLE IF NOT EXISTS `dette` (
  ...
  `numerodet` varchar(100) NOT NULL,
  `datedet` date NOT NULL,
  `montantdet` decimal(10,0) NOT NULL,
  `idClient` int NOT NULL,
  PRIMARY KEY (`iddet`),
  KEY `idClient` (`idClient`)
...
INSERT INTO `dette` (`iddet`, `numerodet`, `datedet`, `montantdet`, `idClient`) VALUES
...
CREATE TABLE IF NOT EXISTS `paiement` (
  ...
  `numeropaie` varchar(100) NOT NULL,
  `datepaie` date NOT NULL,
  `montantpaie` decimal(10,2) NOT NULL,
  `idDette` int NOT NULL,
  PRIMARY KEY (`idpaie`),
  KEY `idDette` (`idDette`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `paiement` (`idpaie`, `numeropaie`, `datepaie`, `montantpaie`, `idDette`) VALUES
...
INSERT INTO `profile` (`idprof`, `libprof`) VALUES
(1, 'Vendeur'),
(2, 'Enseignant');
...
INSERT INTO `users` (`idu`, `nomu`, `prenomu`, `login`, `mdp`, `idProfile`) VALUES
